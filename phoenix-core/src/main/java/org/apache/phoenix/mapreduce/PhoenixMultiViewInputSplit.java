...
public class PhoenixMultiViewInputSplit extends InputSplit implements Writable {
    ...
    public PhoenixMultiViewInputSplit(final List<ViewInfo> viewInfos, long regionSize,
                                      String regionLocation) {
        Preconditions.checkNotNull(viewInfos);
...
//        } else if (!serialized.equals(other.keyRange)) { return false; }
        return true;
    }
