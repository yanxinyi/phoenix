...
public class MathTrigFunctionTest {
    ...
    private static boolean testExpression(LiteralExpression literal, double expectedResult,
        ...
        if (ret) {
            ...
            assertTrue(twoDoubleEquals(result.doubleValue(), expectedResult));
        }

        return ret;
    }

    private static void test(Number value, PNumericType dataType, double expectedResult,
    ...
    @Test
    public void testMathTrigFunction() throws Exception {
        testBatch(
        ...
        testBatch(new Long[] { (long) 1, (long) 0, (long) -1, Long.MAX_VALUE, Long.MIN_VALUE,
                (long) 123, (long) -123 }, PLong.INSTANCE);

        testBatch(new Long[] { (long) 1, (long) 0, Long.MAX_VALUE, (long) 123 },
